...
The goal of this codebook illustrates how the raw data processed and scripted to produce the tidy data which can be used in study or research projects later. The codebook of this projectare not used the files in the Inertial Signals folders. See the README.txt file for the detailed information on the dataset. The files that are used to load data are inclused in the followings:
